...
class BaseRegistry:
    ...
    def remove_executions(self, job: 'Job', pipeline: Optional['Pipeline'] = None) -> Optional[Union[Awaitable, Any]]:
    ...
    def get_expired_job_ids(self, timestamp: Optional[float] = None) -> List[str]:
